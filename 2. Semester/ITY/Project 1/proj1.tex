...
\begin{document}
    ...
    \section{Smíšená sazba}
        ...
        \begin{quotation}
            ...
            {\fontfamily{pag}\selectfont {Čím více druhů}}, \textsc{řezů}, {\tiny{velikostí}}, \,barev písma \underline{a jiných efektů} použijeme, tím \emph{\large{profe\-sionálněji}} bude dokument vypadat. Čtenář tím bude vždy \textsc{nadšen}!
